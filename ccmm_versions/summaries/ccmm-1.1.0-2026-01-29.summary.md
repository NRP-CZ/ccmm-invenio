...
| Name | Type | Required | Array |
|------|------|----------|-------|
| algorithm | checksum_algorithm | ✔️ |  |
...
| Name | Type | Required | Array |
|------|------|----------|-------|
| endpoint_url | related_resource | ✔️ | ✔️ |
| iri | anyURI | ✔️ |  |
| label | multilingual |  |  |
...
| related_resource | related_resource |  | ✔️ |
| resource_type | resource_type |  |  |
| subject | subject | ✔️ | ✔️ |
| terms_of_use | terms_of_use | ✔️ |  |
| time_reference | time_reference | ✔️ | ✔️ |
| title | string | ✔️ |  |
...
| Name | Type | Required | Array |
|------|------|----------|-------|
| distribution_data_service | distribution_data_service | ✔️ |  |
| distribution_downloadable_file | distribution_downloadable_file | ✔️ |  |

## Type: distribution_data_service

| Name | Type | Required | Array |
|------|------|----------|-------|
| access_service | data_service |  | ✔️ |
| conforms_to_specification | application_profile |  | ✔️ |
| description | multilingual |  |  |
| documentation | documentation |  | ✔️ |
| iri | anyURI |  |  |
| title | string | ✔️ |  |

## Type: distribution_downloadable_file
...
| byte_size | integer | ✔️ |  |
| checksum | checksum |  |  |
| conforms_to_schema | application_profile |  | ✔️ |
| download_url | file |  | ✔️ |
| format | format | ✔️ |  |
| iri | anyURI |  |  |
...
| iri | anyURI |  |  |
| name | string |  | ✔️ |
| related_object | related_resource |  | ✔️ |
...
| Name | Type | Required | Array |
|------|------|----------|-------|
| conforms_to_standard | application_profile | ✔️ | ✔️ |
| date_created | date |  |  |
| date_updated | date |  | ✔️ |
| iri | anyURI |  |  |
...
| Name | Type | Required | Array |
|------|------|----------|-------|
| affiliation | organization |  | ✔️ |
| contact_point | contact_details |  | ✔️ |
| family_name | string |  | ✔️ |
| given_name | string |  | ✔️ |
| identifier | identifier |  | ✔️ |
| iri | anyURI |  |  |
| name | string | ✔️ |  |
...
| iri | anyURI |  |  |
| temporal_representation | time_representation | ✔️ |  |
